...
public class AttendeeManagementService {
	...
	public String createAttendee(String type, String firstName, String lastName, String emailAddress, String shirtCut,
		...
		String createAttendeeSQL = "INSERT INTO attendee VALUES('" + aid.toString() + "','" + firstName + "','"
				+ lastName + "','" + emailAddress + "','" + shirtCut + "','" + shirtSize + "','" + dietaryRestrictions
				+ "');";
	...
	private String createDelegate(UUID aid, String major, String university, String province) {
		...
		String createDelegateSQL = "INSERT INTO delegate VALUES('" + aid.toString() + "','" + major + "','" + university
				+ "','" + province + "');";
	...
	public List<Sponsor> getSponsorIDsFromName(String firstName, String lastName) {
		...
		PreparedStatement basicGetting = null;
		String getAttendeeSQL = "SELECT Attendee.aid,emailaddress,companyid FROM Attendee JOIN Sponsor ON Attendee.aid=Sponsor.aid WHERE firstname= '"
	...
	public List<Delegate> getDelegateIDsFromName(String firstName, String lastName) {
		...
		PreparedStatement basicGetting = null;
		String getAttendeeSQL = "SELECT Attendee.aid,emailaddress,major,university FROM Attendee JOIN Delegate ON Attendee.aid=Delegate.aid WHERE firstname= '"
				+ firstName + "' AND lastname= '" + lastName + "';";
	...
	public List<Speaker> getSpeakerIDsFromName(String firstName, String lastName) {
		...
		PreparedStatement basicGetting = null;
		String getAttendeeSQL = "SELECT Attendee.aid,emailaddress FROM Attendee JOIN Speaker ON Attendee.aid=Speaker.aid WHERE firstname= '"
				+ firstName + "' AND lastname= '" + lastName + "';";
